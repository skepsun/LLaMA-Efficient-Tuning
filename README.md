...
## What I modified?
[23/09/18] support additional ptx loss in SFT and PPO stages. Use `--pretrain_dataset` to specify pretrain dataset(s) and `--ptx_coef` to define ptx loss coefficient. This function is not compatible with qlora.
